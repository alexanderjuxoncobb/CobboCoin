...
def connect_node():
    ...
    response = {'message': 'all the nodes are now connected. the cobbo coin blockchai now contains the following nodes:',
...
def replace_chain():
    ...
    if is_chain_replaced:
        response = {'message': 'Node had different chain so was replaced by the longest one.',
